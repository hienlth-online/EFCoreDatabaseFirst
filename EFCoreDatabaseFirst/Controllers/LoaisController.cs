...
namespace EFCoreDatabaseFirst.Controllers
{
    ...
    {
        private readonly EstoreDemoContext _context;

        public LoaisController(EstoreDemoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaLoai,TenLoai,MoTa,Hinh,SoLuong")] Loai loai)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaLoai,TenLoai,MoTa,Hinh,SoLuong")] Loai loai)
        {
            if (id != loai.MaLoai)
            {
                return NotFound();
